...
variable "faces_amis" {
  ...
  default = {
    "ap-southeast-2" = "ami-0314b432d572a8767"
    "eu-west-1"      = "ami-04dbafa81ea9e7024"
    "us-east-1"      = "ami-029176d9727606571"
    "us-east-2"      = "ami-0ccf999d68068e94f"
    "us-west-2"      = "ami-0cdaa282370e84f0e"
  }
}
