...
variable "faces_amis" {
  ...
  default = {
    "ap-southeast-2" = "ami-0754dc04334c8ec8c"
    "eu-west-1"      = "ami-0e5a50528e5a338ca"
    "us-east-1"      = "ami-03700cddcae668329"
    "us-east-2"      = "ami-08ab6fcf78862a31b"
    "us-west-2"      = "ami-035cfbfd50ad528a2"
  }
}
