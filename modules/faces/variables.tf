...
variable "faces_amis" {
  ...
  default = {
    "ap-southeast-2" = "ami-024055ac6e9b228ba"
    "eu-west-1"      = "ami-0b42d3bc8b55c7cdb"
    "us-east-1"      = "ami-0c635e26731be651b"
    "us-east-2"      = "ami-01b49e8d6de479b94"
    "us-west-2"      = "ami-03a0f99d4b2cdb2f4"
  }
}
