...
variable "faces_amis" {
  ...
  default = {
    "ap-southeast-2" = "ami-00e864110eb247836"
    "eu-west-1"      = "ami-035ffcd7e9a6aef1f"
    "us-east-1"      = "ami-06a6465e77d363244"
    "us-east-2"      = "ami-000a06808675a9cf8"
    "us-west-2"      = "ami-0fde8e844df41e74b"
  }
}
