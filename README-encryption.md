...
module "servicesiam" {
    source = "github.com/graymeta/terraform-aws-platform//modules/servicesiam?ref=v0.0.14"
...
module "network" {
    source = "github.com/graymeta/terraform-aws-platform//modules/network?ref=v0.0.14"

    ... (see README.md for details)
}

module "platform" {
    source = "github.com/graymeta/terraform-aws-platform?ref=v0.0.14"
